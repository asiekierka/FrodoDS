...
private:
	...
	c64_dir_entry **file_info;	// Vector of file information structs for all files in the archive
...
extern bool ReadArchDirectory(const char *path, c64_dir_entry **dir_entries);
